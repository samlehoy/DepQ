  ...
  return (
    <div className="min-h-screen bg-[var(--ds-background)] flex items-center justify-center p-4 sm:p-8">
      <div className="w-full max-w-md">
        ...
        <h2 className="text-h2-ui text-[var(--ds-on-surface)] mb-6">{t.signIn}</h2>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div className="text-right">
            <Link to="/register" className="text-caption text-[var(--ds-primary)] hover:underline font-semibold">{t.registerNow}</Link>
          </div>
