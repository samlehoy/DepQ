    ...
    <div className="bg-white font-sans min-h-screen">
      <div className="max-w-md mx-auto">
        <div className="min-h-screen flex flex-col justify-center p-8">
          ...
          <h2 className="text-xl font-regular text-slate-800 mb-4">Login</h2>

          {error && <div className="bg-red-50 text-red-500 p-3 rounded-lg mb-4 text-sm">{error}</div>}

          <form className="w-full space-y-5" onSubmit={handleLogin}>
            <div>
              <label htmlFor="email" className="font-semibold text-sm text-slate-600 block">E-mail</label>
              <input 
                type="email" 
                id="email" 
                name="email" 
            ...
            <div>
              <label htmlFor="password" className="font-semibold text-sm text-slate-600 block">Password</label>
              <input 
                type="password" 
                id="password" 
                name="password" 
            ...
            <div className="text-right">
              <Link to="/register" className="font-semibold text-sm text-teal-800 hover:underline">Register now</Link>
            </div>

            <div className="w-full mt-36 space-y-4 pt-12">
              <button 
                type="submit"
                disabled={loading}
